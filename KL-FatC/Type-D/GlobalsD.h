...
#define GRAPH_FILE "graph-" TOSTRING(RANK) "," TOSTRING(RANK) "-D-Big.film" // -81 only valid for type D6! (testing purposes) 
#define OUTPUT_FILE "output-" TOSTRING(RANK) "," TOSTRING(RANK) "-D.kl" 
#define DEBUG_FILE "debug-" TOSTRING(RANK) "," TOSTRING(RANK) "-D.txt" 
#define LOG_FILE "log-" TOSTRING(RANK) "," TOSTRING(RANK) "-D.txt" 

#if RANK==4
#define MAX_WEIGHT {0,0,4}
#define INVERSE {{3,2,1},{2,4,2},{1,2,3}}
#elif RANK==5
#define MAX_WEIGHT {4,3,4,4}
#define INVERSE {{4,4,2,2},{4,8,4,4},{2,4,4,2},{2,4,2,4}}
#elif RANK==6
#define MAX_WEIGHT {6,5,6,6,6}
#define INVERSE {{4,4,4,2,2},{4,8,8,4,4},{4,8,12,6,6},{2,4,6,5,3},{2,4,6,3,5}}
#elif RANK==7
#define MAX_WEIGHT {80,1,0,0,0,0}
